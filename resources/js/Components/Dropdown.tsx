...
const Content = ({ align = 'right', width = '48', contentClasses = 'select-none py-1 bg-white', children }: PropsWithChildren<{ align?: 'left'|'right', width?: '48', contentClasses?: string }>) => {
