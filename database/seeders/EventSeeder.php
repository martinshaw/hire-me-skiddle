...
class EventSeeder extends Seeder
{
    ...
    public function run(): void
    {
         ...
         */
        $dateTimePointer = now()->subMinutes(24);
        ...
        $informationForOngoingEvent = $realEventInformation[$artistForOngoingEvent->name][array_rand($realEventInformation[$artistForOngoingEvent->name])];
        ...
        DB::table('events')->insert([
            ...
            'starts_at' => $dateTimePointer,
            'ends_at' => $dateTimePointer->addHours(3),
            'artist_id' => $artistForOngoingEvent->id,
            'venue_id' => $artistForOngoingEvent->venue_id,
            'tickets_purchased' => $venueForOngoingEvent->typical_capacity * 0.7,
